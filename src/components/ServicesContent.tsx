...
const icons = [
  // Shopping cart
  <svg key="vente" className="w-12 h-12" style={{ color: "#1E3080" }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  // Restaurant
  <svg key="restaurant" className="w-12 h-12" style={{ color: "#1E3080" }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
  </svg>,
  // Service
  <svg key="service" className="w-12 h-12" style={{ color: "#1E3080" }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
